...
const WomansFashion = () => {
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            try {
                const response = await fetch(`https://webshop.free.nf/womans_fashion.php`, {mode: 'no-cors'}) ; 
                if (!response.ok) {
    ...
    return (
        <div>
            <h1 className='text-center mt-2 text-danger fw-bolder'>Woman's Fashion</h1>
