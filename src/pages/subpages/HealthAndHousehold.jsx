...
const HealthAndHousehold = () => {
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            try {
                const response = await fetch(`https://webshop.free.nf/health&household.php`, {mode: 'no-cors'}); 
                if (!response.ok) {
    ...
    return (
        <div>
            <h1 className='text-center mt-2 text-danger fw-bolder'>Health & Household</h1>
...
export default HealthAndHousehold
