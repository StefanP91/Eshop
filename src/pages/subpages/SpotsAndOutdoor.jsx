...
const SpotsAndOutdoor = () => {
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            try {
                const response = await fetch(`http://platfromshop.atwebpages.com/sports&outdoor.php`); 
                if (!response.ok) {
    ...
    return (
        <div>
            <h1 className='text-center mt-2 text-danger fw-bolder'>Sports & Outdoor</h1>
...
export default SpotsAndOutdoor
